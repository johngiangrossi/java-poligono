...
public abstract class triangle extends Polygon {
    ...
    // costruttore
    public triangle(int sides, int late1, int late2, int late3) {
        super(0);
        if (late1 < 0 || late2 < 0 || late3 < 0) {
    ...
    public double getArea() {
        ...
        return Math.sqrt((late1 + late2 + late3) * (-late1 + late2 + late3) * (late1 - late2 + late3) * (late1 + late2 - late3)) / 4;
